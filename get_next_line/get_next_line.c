...
/*   Updated: 2024/04/25 17:56:04 by maugusto         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main() {
    ...
    char *line;
    while ((line = get_next_line(fd)) != NULL) { // Lendo e imprimindo cada linha do arquivo
        printf("%s\n", line);
        free(line); // Liberando a memória alocada para a linha
    }
