...
/*   Updated: 2024/06/18 18:09:25 by maugusto         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	put_imgs_to_variables(t_idk *game)
{
	...
	game->guy_in_wall = mlx_xpm_file_to_image(game->mlx, "map/wallg.xpm",
			&i, &j);
	...
	game->player1 = mlx_xpm_file_to_image(game->mlx, "map/P1.xpm",
			&i, &j);
